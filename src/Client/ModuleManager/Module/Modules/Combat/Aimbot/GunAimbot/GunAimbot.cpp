...
namespace Client::Module::AimbotModule::GunAimbotModule
{
    ...
    void GunAimbot::onPreCreateMove(CUserCmd *cmd, C_TerrorWeapon *pWeapon, C_TerrorPlayer *pLocal)
    {
    ...
    void GunAimbot::onRender2D(C_TerrorPlayer *pLocal, C_TerrorWeapon *pWeapon)
    {
    ...
    bool GunAimbot::isInvaildOrDead(C_TerrorPlayer *pLocal, C_TerrorWeapon *pWeapon)
    {
        auto aimbot = Client::client.moduleManager.aimbot;
    ...
    bool GunAimbot::isInCrossHair(CUserCmd *cmd, C_TerrorPlayer *pLocal, IClientEntity *target)
    {
